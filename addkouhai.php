          ...
          <div class="col-md-4">
            <div class="card ">
              ...
              <div class="card-body">
                <form action="proses-crud.php" method="POST">
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-md-1">
                      <div class="form-group">
                        <label for="npm_senpai">NPM Senpai</label>
                        <select class="form-control" id="exampleFormControlSelect1" name="npm_senpai">
                          <?php 


                          if ($type_id == 1) {
                            $sql1 = "SELECT npm, CONCAT(npm,' - ',nama) AS senpai FROM tb_senpai WHERE kd_prodi = '$prodi'";
                          ...
                          if ($type_id == 3) {
                            $sql1 = "SELECT npm, CONCAT(npm,' - ',nama) AS senpai FROM tb_senpai";
              ...
              <div class="card-footer">
                <input type="submit" class="btn btn-fill btn-primary" value="Add" name="addkouhai"></input>
