...
include("config.php");
  ...
  $nik = $_GET['nik'];
  $sql = "SELECT * FROM tb_dosen WHERE nik = $nik";
  $query = mysqli_query($db, $sql);

  while ($dosen = mysqli_fetch_array($query)){
    $nik = $dosen['nik'];
    $nama = $dosen['nama'];
    $prodi = $dosen['kd_prodi'];
          ...
          <div class="col-md-4">
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <form action="proses-crud.php?nik=<?php echo $id?>" method="POST">
                  <div class="row">
                    <div class="col-md-11 pr-md-1">
                      <div class="form-group">
                        <label for="nik">NIK</label>
                        <input type="text" class="form-control" placeholder="NIK" name="nik" value="<?php echo $nik ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="e.g. = lecturer" name="jabatan" value="<?php echo $jabatan ?>">
                      </div>
                    </div>
                  </div>
              <div class="card-footer">
                <input type="submit" class="btn btn-fill btn-primary" value="Save" name="editdosen"></input>
                <a href="./manage.php" class="btn btn-fill btn-secondary">Cancel</a>
              </div>
            </form>
            </div>
          </div>
