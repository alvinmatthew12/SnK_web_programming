                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="receiver">
                          ...
                          if ($type_id == 1) {
                            $sql = "SELECT npm, CONCAT(npm,' - ',nama) AS senpai FROM tb_senpai WHERE kd_prodi = '$prodi'";
                          ...
                          ?>
                           ...
                           <option class='text-info' value='<?php echo $prodi ?>'>All</option>
                          ...
                          <?php
                          if ($type_id == 2) {
                            $sql = "SELECT nik, CONCAT(nik,' - ',nama) AS dosen FROM tb_dosen WHERE kd_prodi = '$prodi'";
                          ...
                          <?php
                          if ($type_id == 3) {
                            $sql = "SELECT nik, CONCAT(nik,' - ',nama) AS dosen FROM tb_dosen";
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea rows="1" cols="80" class="form-control" placeholder="Add a subject" name="subject"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
      ...
      <?php if (isset($_GET['status'])): ?>
        <?php 
          if ($_GET['status']=='sendsuccess') { ?>
            ...
            <span data-notify="message"><b>Message</b> has been Sent Successfully</span><a href="#" target="_blank" data-notify="url"></a></div>
        ...
        <?php 
          if ($_GET['status']=='sendfailed') { ?>
            ...
            <span data-notify="title"></span> 
            <span data-notify="message">Failed to Send <b>Message</b></span><a href="#" target="_blank" data-notify="url"></a></div>
