          ...
          <div class="col-md-4">
            <div class="card ">
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="e.g. = lecturer" name="jabatan">
                      </div>
                    </div>
                  </div>
                  <hr>
              ...
              <div class="card-footer">
                <input type="submit" onclick="demo.showNotification('top','center')" class="btn btn-fill btn-primary" value="Add" name="adddosen"></input>
