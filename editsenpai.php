...
$npm = $_GET['npm'];
$sql = "SELECT * FROM tb_senpai WHERE npm = $npm";
$query = mysqli_query($db, $sql);

while ($senpai = mysqli_fetch_array($query)){
  $npm = $senpai['npm'];
  $nama = $senpai['nama'];
  $prodi = $senpai['kd_prodi'];
  $semester = $senpai['semester'];
}
                  ...
                  <div class="row">
                    <div class="col-md-11 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="e.g. = 3" name="semester" value="<?php echo $semester ?>">
                      </div>
                    </div>
                  </div>
              <div class="card-footer">
                <input type="submit" class="btn btn-fill btn-primary" value="Save" name="editsenpai"></input>
