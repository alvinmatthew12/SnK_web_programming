                    ...
                    <tbody>
                      ...
                      if ($type_id == 3) {
                        ...
                        while ($kouhai = mysqli_fetch_array($query)) {
                          ...
                          echo "<a href='editkouhai.php?npm=".$kouhai['npm']."'><button type='button' rel='tooltip' class='btn btn-info btn-link btn-icon btn-sm'><i class='tim-icons icon-settings'></i></button></a>";
                          echo "<a href='proses-deletekouhai.php?npm=".$kouhai['npm']."'><button type='button' rel='tooltip' class='btn btn-danger btn-link btn-icon btn-sm'><i class='tim-icons icon-simple-remove'></i></button></a>";
                          echo "</td>";
                          echo "</tr>";
                        }
                      }
      ...
      <?php if (isset($_GET['status'])): ?>
        <?php 
          if ($_GET['status']=='addsuccess') { ?>
            ...
            <span data-notify="message">Add <b>Kouhai</b> Success</span><a href="#" target="_blank" data-notify="url"></a></div>
        ...
        <?php 
          if ($_GET['status']=='addfailed') { ?>
            ...
            <span data-notify="title"></span> 
            <span data-notify="message">Failed to Add <b>Kouhai</b></span><a href="#" target="_blank" data-notify="url"></a></div>
        ...
        <?php 
          if ($_GET['status']=='editsuccess') { ?>
            ...
            <span data-notify="icon" class="tim-icons icon-check-2"></span>
            <span data-notify="title"></span> 
            <span data-notify="message">Edit <b>Kouhai</b> Success</span><a href="#" target="_blank" data-notify="url"></a></div>
        ...
        <?php 
          if ($_GET['status']=='editfailed') { ?>
            ...
            <span data-notify="icon" class="tim-icons icon-alert-circle-exc"></span>
            <span data-notify="title"></span> 
            <span data-notify="message">Failed to Edit <b>Kouhai</b></span><a href="#" target="_blank" data-notify="url"></a></div>
        ...
        <?php 
          if ($_GET['status']=='deletesuccess') { ?>
            ...
            <span data-notify="icon" class="tim-icons icon-check-2"></span>
            <span data-notify="title"></span> 
            <span data-notify="message">Delete <b>Kouhai</b> Success</span><a href="#" target="_blank" data-notify="url"></a></div>
        ...
        <?php 
          if ($_GET['status']=='deletefailed') { ?>
            ...
            <span data-notify="icon" class="tim-icons icon-alert-circle-exc"></span>
            <span data-notify="title"></span> 
            <span data-notify="message">Failed to Delete <b>Kouhai</b></span><a href="#" target="_blank" data-notify="url"></a></div>
    ...
    <script type="text/javascript">
      function movepage(choose){
        if (choose == "1"){
          ...
          window.location.assign("addkouhai.php")
        }
